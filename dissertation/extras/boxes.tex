...
\newtcbtheorem[list inside={eg},number within=section,crefname={example}{examples}]{example}{Example}{
  colback=boxorange!30,
  colframe=boxorange
}{eg}

\newtcbtheorem[list inside={rem},number within=section,crefname={remark}{remarks}]{remark}{Remark}{
