...
\newtcbtheorem[number within=section]{example}{Example}{parbox=false,breakable=true,colback=boxorange!30,colframe=boxorange,fonttitle=\bfseries}{eg}

\newtcbtheorem[number within=section]{remark}{Remark}{parbox=false,breakable=true,colback=boxpurple!20,colframe=boxpurple,fonttitle=\bfseries}{rem}
