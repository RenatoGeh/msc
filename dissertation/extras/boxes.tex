...
\newtcbtheorem[number within=section]{example}{Example}{colback=boxorange!30,colframe=boxorange}{eg}

\newtcbtheorem[number within=section]{remark}{Remark}{colback=boxpurple!20,colframe=boxpurple}{rem}
