...
\NewDocumentCommand{\@versoPageBlock}{} {
    ...
    \item
      ...
      \fbox{
        \begin{minipage}[t]{120mm}
          ...
          \noindent Geh, Renato Lui\\
          Scalable Learning of Probabilistic Circuits / Renato Lui Geh; orientador, Denis Deratani Mauá.
          - São Paulo, 2022.\\
          144 p.: il.
          \vskip 1em

          Dissertação (Mestrado) - Programa de Pós-Graduação em Ciência da Computação / Instituto
          de Matemática e Estatística / Universidade de São Paulo.\\
          Bibliografia\\
          Versão corrigida
          \vskip 1em

          1. Circuitos probabilísticos. 2. Aprendizado de máquina. 3. Modelos
          probabilísticos. 4. Inteligência Artificial. I. Mauá, Denis Deratani. II. Título.
        \end{minipage}
      }
      \end{Center}
      \vspace*{3cm plus 3cm minus 1cm}
  ...
  responsáveis pela estrutura de catalogação da publicação de acordo com a AACR2: Maria Lúcia
  Ribeiro CRB-8/2766; Stela do Nascimento Madruga CRB 8/7534.
