...
\Cref{tab:details} shows detailed information of every dataset evaluated.
...
algorithm discussed in \Cref{sec:learnpsdd}; when the domain is continuous, we replace mutual
...
\begin{table}[t]
  ...
  \begin{tabular}{c|cccc|ccccc}
    ...
    \hline
    \textsc{nltcs}     & 7m   & 3m  & 6m    & 17s   & 3m19s & 15s    & 5s     & 3s     & 4s    \\
    \textsc{plants}    & 50m  & 41m & 26m   & 1m3s  & 26m   & 2m7s   & 41s    & 28s    & 52s   \\
    \textsc{audio}     & 2h   & 33m & 51m   & 1m58s & 37m   & 4m3s   & 1m16s  & 52s    & 1m25s \\
    \textsc{jester}    & 52m  & 24m & 37m   & 1m20s & 29m   & 4m48s  & 1m29s  & 1m1s   & 1m20s \\
    \textsc{netflix}   & 1h   & 14m & 33m   & 2m8s  & 46m   & 4m36s  & 1m28s  & 1m     & 1m40s \\
    \textsc{accidents} & 47m  & 20m & 41m   & 1m47s & 33m   & 4m     & 1m20s  & 55s    & 1m30s \\
    \textsc{book}      & >3h  & 8m  & 1h22m & 2m26s & 2h    & 25m13s & 7m55s  & 5m10s  & 7m24s \\
    \textsc{dna}       & >3h  & >3h & >3h   & 17s   & 11m   & 7m38s  & 2m20s  & 1m33s  & 1m27s \\
    \hline
  \end{tabular}
  }
...
in terms of average rank. We also note how \textproc{LearnRP} is consistent in its ranking, as
their rank standard deviation shows. \Cref{fig:learnrp-curves} shows how much minibatch EM
improves \textproc{LearnRP} and how many iterations are needed for it to match the performance of
competitors.

\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{bins/all.pdf}
  \caption{Performance of \textproc{LearnRP} under different iterations of minibatch EM. The curve
    in \protect\tikz\protect\fill[baseline=0.5ex,fill=jplots1] (0,0) rectangle (0.5,-0.1); shows the test
    log-likelihood of \textproc{LearnRP} under different iterations of EM. Each horizontal line
    shows the performance of competitors: \protect\tikz\protect\fill[baseline=0.5ex,fill=jplots2] (0,0) rectangle
    (0.5,-0.1); for \textproc{XPC}, \protect\tikz\protect\fill[baseline=0.5ex,fill=jplots3] (0,0) rectangle
    (0.5,-0.1); for \textproc{Strudel}, \protect\tikz\protect\fill[baseline=0.5ex,fill=jplots4] (0,0) rectangle
    (0.5,-0.1); for \textproc{LearnSPN}, \textproc{LearnPSDD} in
    \protect\tikz\protect\fill[baseline=0.5ex,fill=jplots5] (0,0) rectangle (0.5,-0.1); and finally
    \textproc{Prometheus} in \protect\tikz\protect\fill[baseline=0.5ex,fill=jplots10] (0,0) rectangle (0.5,-0.1);.}
...
performance as evidenced in \Cref{tab:binary}.
...
\begin{table}[t]
  ...
  \begin{tabular}{c|cccccc|cc}
    \hline
    \textbf{Dataset} & \textbf{SRBMs} & \textbf{oSLRAU} & \textbf{GBMMs} & \textbf{iGMMs} &
