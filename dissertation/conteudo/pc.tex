...
nodes follow a hierarchy. This hierarchy is easily visualized through a \emph{vtree} (i.e.\ a
variable tree), a binary tree that defines a (partial) ordering of variables.

\begin{definition}[Vtree]
  A variable tree, or \emph{vtree}, is a binary
\end{definition}

We shall adopt the same scope notation as in PCs. Let $v$ a vtree node from a vtree $\mathcal{V}$.
