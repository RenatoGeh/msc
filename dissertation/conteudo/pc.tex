...
that same query. This concept becomes clearer when we talk about reasoning in \Cref{sec:inf} and
...
%Before we continue, we must draw a clear distinction between the \emph{semantics} of a PC, i.e.\
%the probabilistic meaning of the computational graph and their nodes, as well as their values; and
%the \emph{syntax} and syntactical properties of these mathematical objects.
...
%Before we address the \emph{semantics} of probabilistic circuits, including the probabilistic
%meaning of the computational graph, it may be sensible to first discuss the \emph{syntax} around
%the PCs. To this end, we shall now introduce \emph{sum} and \emph{product} (inner) nodes from an
%operational point of view. We
