...
\begin{figure}[t]
  \begin{subfigure}[t]{0.45\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \newOrNode[inputs=nn,fill=boxpurple!60]{s1}{$(p1) + (-1.5,-1)$};
      \newOrNode[inputs=nn,fill=boxpurple!60]{s2}{$(p2) + (1.5,-1)$};
      \newAndNode[inputs=nn,fill=boxblue!80]{q1}{$(s1) + (-0.5,-1)$};
      \newAndNode[inputs=nn,fill=boxblue!80]{q2}{$(s1) + (0.5,-1)$};
      \newAndNode[inputs=nn,fill=boxblue!80]{q3}{$(s1) + (1.75,-1)$};
      \newAndNode[inputs=nn,fill=boxblue!80]{q4}{$(s2) + (-1.75,-1)$};
      \newAndNode[inputs=nn,fill=boxblue!80]{q5}{$(s2) + (-0.5,-1)$};
      \newAndNode[inputs=nn,fill=boxblue!80]{q6}{$(s2) + (0.5,-1)$};
      \node (c) at ($(q1) + (-0.5,-1)$) {$C$};
      \newOrNode[inputs=nn,fill=boxorange!80]{z1}{$(q1) + (0.5,-1.5)$};
      \node (nc1) at ($(q2) + (0.5,-1)$) {$\neg C$};
      \node (nc2) at ($(q3) + (0.5,-1)$) {$\neg C$};
      \node (a1) at ($(q4) + (-0.5,-1)$) {$A$};
      \node (a2) at ($(q5) + (-0.5,-1)$) {$A$};
      \node (nb1) at ($(q5) + (0.3,-1)$) {$\neg B$};
      \newOrNode[inputs=nn,fill=boxorange!80]{z2}{$(q6.input 1) + (0,-1.25)$};
      \node (na) at ($(q6) + (0.75,-1)$) {$\neg A$};
      \node (nd) at ($(z1) + (-0.5,-1)$) {$\neg D$};
      \node (d) at ($(z1) + (1.5,-1)$) {$D$};
      \node (b) at ($(z2) + (-2.0,-1)$) {$B$};
      ...
      \draw[edge] (p1.input 1) -- ++(0,-0.2) -| (s1);
      \draw[edge] (p2.input 2) -- ++(0,-0.2) -| (s2);
      ...
      \draw[edge] (q1.input 2) -- ++(0,-0.2) -| (z1);
      \draw[edge] (q2.input 1) -- ++(0,-0.2) -| (z1);
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \newOrNode[inputs=nn,fill=boxteal]{z1}{$(q1.input 1) + (0,-0.75)$};
      \node (b1) at ($(q1) + (0.5,-1)$) {$B$};
      \node (nb1) at ($(q2) + (-0.5,-1)$) {$\neg B$};
      \newAndNode[inputs=nn,fill=boxteal]{z2}{$(q2) + (0.5,-1.0)$};
      \node (nc1) at ($(q3) + (-0.5,-1.5)$) {$\neg C$};
      \node (d1) at ($(q3) + (0.5,-1.5)$) {$D$};
      \node (b2) at ($(q4) + (-0.5,-1.5)$) {$B$};
      \node (nb2) at ($(q4) + (0.5,-1.5)$) {$\neg B$};
      \newAndNode[inputs=nn,fill=boxorange!80]{t1}{$(z1) + (-0.5,-1)$};
      \newAndNode[inputs=nn,fill=boxorange!80]{t2}{$(z1) + (0.5,-1)$};
    ...
    \label{fig:lc2}
  \end{subfigure}
  \caption{Logic circuits encoding the logic constraint $\phi\equiv(A\wedge B)\vee(\neg C\wedge
  D)$.}
\end{figure}
