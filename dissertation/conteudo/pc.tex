...
\begin{example}[sidebyside,lefthand width=0.55\textwidth]{Density estimation trees as probabilistic circuits}{det}
  ...
  Equivalently, a smooth and nondecomposable PC whose sum nodes are followed by products which
  ...
  decision nodes in the DET. Because the resulting density is constant-piecewise, marginalization
  is tractable, highlighting the sufficiency but not necessity of smoothness and decomposability.
  An alternative smooth and decomposable formulation of DETs is given by \citet{correia20}.
  \tcblower
  \centering
  \begin{tikzpicture}
