...
\Cref{eg:det} later shows), these two properties are often adopted during learning due to their
...
\begin{example}[sidebyside,lefthand width=0.55\textwidth]{Density estimation trees as probabilistic circuits}{det}
  ...
  \begin{tikzpicture}
    ...
    \node[inner sep=1pt,minimum size=12pt,circle,fill=boxblue!80] (a) at (3,-0.5) {$\set{A}$};
    ...
    \newLeafNode[fill=boxblue!80,label=below:{$\left\liv\set{x}\leq\set{A}\right\riv$}]{ai}{$(al) + (-1.0,-1)$};
    \newLeafNode[fill=boxblue!80,label=below:{$\left\liv\set{x}>\set{A}\right\riv$}]{nai}{$(ar) + (1.0,-1)$};
    ...
    \newLeafNode[fill=boxgreen!80,label=below:{$\left\liv\set{x}\leq\set{B}\right\riv$}]{bi}{$(bl) + (-1.0,-1)$};
    \newLeafNode[fill=boxgreen!80,label=below:{$\left\liv\set{x}>\set{B}\right\riv$}]{nbi}{$(br) + (1.0,-1)$};
    \draw[edge] (al) -- (b);
    ...
    \newLeafNode[fill=boxpurple!60,label=below:{$\left\liv\set{x}\leq\set{C}\right\riv$}]{ci}{$(cl) + (-1.0,-1)$};
    \newLeafNode[fill=boxpurple!60,label=below:{$\left\liv\set{x}>\set{C}\right\riv$}]{nci}{$(cr) + (1.0,-1)$};
    \draw[edge] (br) -- (c);
    \draw[edge] (c) -- (cl); \draw[edge] (cl) -- (ci);
    \draw[edge] (c) -- (cr); \draw[edge] (cr) -- (nci);
...
formally in \Cref{alg:map}. To find the assignment $\set{y}$ that maximizes \Cref{eq:map} in a
...
$\mathcal{C}$ through \Cref{alg:argmap}. This maximum induced tree can be retrieved by a top-down
...
%\begin{figure}[t]
  %\begin{subfigure}[t]{0.32\textwidth}
    ...
    %\begin{tikzpicture}
      ...
      %\newSumNode[fill=boxred!70]{p}{$(r) + (-1.25,-0.75)$};
      %\newSumNode[fill=boxpurple!60]{q}{$(r) + (1.25,-0.75)$};
      %\newProdNode[fill=boxteal]{t1}{$(p) + (-0.6,-1)$};
      %\newProdNode[fill=boxorange!80]{t2}{$(p) + (0.65,-1)$};
      %\newProdNode[fill=boxpink!50]{t3}{$(q) + (-0.6,-1)$};
      %\newProdNode[fill=boxgoldenrod!70]{t4}{$(q) + (0.6,-1)$};
      %\newGaussNode[fill=boxteal]{x1}{$(t1) + (0.6,-1.3)$};
      %\newGaussNode[fill=boxorange!80]{x2}{$(t2) + (0.6,-1.3)$};
      %\newGaussNode[fill=boxpink!50]{y1}{$(t3) + (0.6,-1.3)$};
      %\newGaussNode[fill=boxgoldenrod!70]{y2}{$(t4) + (0.6,-1.3)$};
      %\node (i1) at ($(t1) + (-0.25,-0.8)$) {\scriptsize$\left\liv\mathbf{x\leq 3}\right\riv$};
      %\node (i2) at ($(t2) + (-0.25,-0.8)$) {\scriptsize$\left\liv\mathbf{x>3}\right\riv$};
      %\node (i3) at ($(t3) + (-0.25,-0.8)$) {\scriptsize$\left\liv\mathbf{y\leq 4}\right\riv$};
      %\node (i4) at ($(t4) + (-0.25,-0.8)$) {\scriptsize$\left\liv\mathbf{y>4}\right\riv$};
      %\draw[edge] (r) edge[bend right=5] (p);
      %\draw[edge] (r) edge[bend right=5] (q);
      %\draw[edge] (p) edge[bend right=5] (t1);
      %\draw[edge] (p) edge[bend right=5] (t2);
      %\draw[edge] (q) edge[bend right=5] (t3);
      %\draw[edge] (q) edge[bend right=5] (t4);
      %\draw[edge] (t1) edge[bend right=5] (x1);
      %\draw[edge] (t2) edge[bend right=5] (x2);
      %\draw[edge] (t3) edge[bend right=5] (y1);
      %\draw[edge] (t4) edge[bend right=5] (y2);
      %\draw[edge] (t1) edge[bend right=5] (i1);
      %\draw[edge] (t2) edge[bend right=5] (i2);
      %\draw[edge] (t3) edge[bend right=5] (i3);
      %\draw[edge] (t4) edge[bend right=5] (i4);
      %\node at ($(p) + (-0.5,-0.4)$) {\scriptsize$.3$};
      %\node at ($(p) + (0.5,-0.4)$) {\scriptsize$.7$};
      %\node at ($(q) + (-0.5,-0.4)$) {\scriptsize$.6$};
      %\node at ($(q) + (0.5,-0.4)$) {\scriptsize$.4$};
      %\node (l1) at ($(x1) + (0,-0.5)$) {\scriptsize\colorbox{boxteal}{\color{white}$\mathbf{.80}$}};
      %\node (l2) at ($(x2) + (0,-0.5)$) {\scriptsize\colorbox{boxorange}{\color{white}$\mathbf{.02}$}};
      %\node (l3) at ($(y1) + (0,-0.5)$) {\scriptsize\colorbox{boxpink}{\color{white}$\mathbf{.20}$}};
      %\node (l4) at ($(y2) + (0,-0.5)$) {\scriptsize\colorbox{boxgoldenrod}{\color{white}$\mathbf{.04}$}};
      %\draw[edge,boxdgray] (p) edge[bend left=-5] (r);
      %\draw[edge,boxdgray] (q) edge[bend left=-5] (r);
      %\draw[edge,boxdgray] (t1) edge[bend right=5] (p);
      %\draw[edge,boxdgray] (t2) edge[bend right=5] (p);
      %\draw[edge,boxdgray] (t3) edge[bend right=5] (q);
      %\draw[edge,boxdgray] (t4) edge[bend right=5] (q);
      %\draw[edge,boxdgray] (i1) edge[bend right=5] (t1);
      %\draw[edge,boxdgray] (i2) edge[bend right=5] (t2);
      %\draw[edge,boxdgray] (i3) edge[bend right=5] (t3);
      %\draw[edge,boxdgray] (i4) edge[bend right=5] (t4);
      %\draw[edge,boxdgray] (x1) edge[bend left=-5] (t1);
      %\draw[edge,boxdgray] (x2) edge[bend left=-5] (t2);
      %\draw[edge,boxdgray] (y1) edge[bend left=-5] (t3);
      %\draw[edge,boxdgray] (y2) edge[bend left=-5] (t4);
      %\node at ($(t1) + (-0.4,0.5)$) {\scriptsize\colorbox{boxteal}{\color{white}$\mathbf{.8}$}};
      %\node at ($(t2) + (0.3,0.5)$) {\scriptsize\colorbox{boxorange}{\color{white}$\mathbf{.0}$}};
      %\node at ($(t3) + (-0.3,0.5)$) {\scriptsize\colorbox{boxpink}{\color{white}$\mathbf{.2}$}};
      %\node at ($(t4) + (0.4,0.5)$) {\scriptsize\colorbox{boxgoldenrod}{\color{white}$\mathbf{.0}$}};
      %\node at ($(p) + (-0.3,0.6)$) {\scriptsize\colorbox{boxred}{\color{white}$\mathbf{.25}$}};
      %\node at ($(q) + (0.3,0.6)$) {\scriptsize\colorbox{boxpurple}{\color{white}$\mathbf{.74}$}};
      %\node (x) at ($(p) + (0.,-4.0)$) {\scriptsize\colorbox{boxblue}{\color{white}$\mathstrut\mathbf{x=2}$}};
      %\node (y) at ($(q) + (0,-4.0)$) {\scriptsize\colorbox{boxblue}{\color{white}$\mathstrut\mathbf{y=4}$}};
      %\draw[edge,boxdgray] (x) edge[bend left=5] (l1);
      %\draw[edge,boxdgray] (x) edge[bend right=10] (l2);
      %\draw[edge,boxdgray] (x) edge[bend left=10] (i1);
      %\draw[edge,boxdgray] (x) edge[bend right=20] (i2);
      %\draw[edge,boxdgray] (y) edge[bend left=5] (l3);
      %\draw[edge,boxdgray] (y) edge[bend right=10] (l4);
      %\draw[edge,boxdgray] (y) edge[bend left=10] (i3);
      %\draw[edge,boxdgray] (y) edge[bend right=20] (i4);
      %\node (out) at ($(r) + (0,0.9)$) {\scriptsize\colorbox{boxgreen}{\color{white}$\mathbf{.035}$}};
      %\draw[edge,boxdgray] (r) edge (out);
    %\end{tikzpicture}
    %}
    %\caption{}
  ...
  %\begin{subfigure}[t]{0.32\textwidth}
    ...
    %\begin{tikzpicture}
      %\newProdNode[fill=boxgreen]{r}{0,0};
      %\newMaxNode[fill=boxred!70]{p}{$(r) + (-1.25,-0.75)$};
      %\newMaxNode[fill=boxpurple!60]{q}{$(r) + (1.25,-0.75)$};
      %\newProdNode[fill=boxteal]{t1}{$(p) + (-0.6,-1)$};
      %\newProdNode[fill=boxorange!80]{t2}{$(p) + (0.65,-1)$};
      %\newProdNode[fill=boxpink!50]{t3}{$(q) + (-0.6,-1)$};
      %\newProdNode[fill=boxgoldenrod!70]{t4}{$(q) + (0.6,-1)$};
      ...
      %\node (l1) at ($(x1) + (0,-0.5)$) {\scriptsize\colorbox{boxteal}{\color{white}$\mathbf{.80}$}};
      %\node (l2) at ($(x2) + (0,-0.5)$) {\scriptsize\colorbox{boxorange}{\color{white}$\mathbf{.02}$}};
      %\node (l3) at ($(y1) + (0,-0.5)$) {\scriptsize\colorbox{boxpink}{\color{white}$\mathbf{.56}$}};
      %\node (l4) at ($(y2) + (0,-0.5)$) {\scriptsize\colorbox{boxgoldenrod}{\color{white}$\mathbf{.99}$}};
      %\draw[edge,boxdgray] (p) edge[bend left=-5] (r);
      %\draw[edge,boxdgray] (q) edge[bend left=-5] (r);
      %\draw[edge,boxdgray] (t1) edge[bend right=5] (p);
      %\draw[edge,boxdgray] (t2) edge[bend right=5] (p);
      ...
      %\node at ($(t1) + (-0.4,0.5)$) {\scriptsize\colorbox{boxteal}{\color{white}$\mathbf{.8}$}};
      %\node at ($(t2) + (0.3,0.5)$) {\scriptsize\colorbox{boxorange}{\color{white}$\mathbf{.0}$}};
      %\node at ($(t3) + (-0.3,0.5)$) {\scriptsize\colorbox{boxpink}{\color{white}$\mathbf{.56}$}};
      %\node at ($(t4) + (0.4,0.5)$) {\scriptsize\colorbox{boxgoldenrod}{\color{white}$\mathbf{.99}$}};
      %\node at ($(p) + (-0.3,0.6)$) {\scriptsize\colorbox{boxred}{\color{white}$\mathbf{.25}$}};
      %\node at ($(q) + (0.3,0.6)$) {\scriptsize\colorbox{boxpurple}{\color{white}$\mathbf{.14}$}};
      %\node (x) at ($(p) + (0,-4.0)$) {\scriptsize\colorbox{boxblue}{\color{white}$\mathstrut\mathbf{x=2}$}};
      %\node (y) at ($(q) + (0,-4.0)$) {\scriptsize\colorbox{boxblue}{\color{white}$\mathstrut\mathbf{\max y}$}};
      %\draw[edge,boxdgray] (x) edge[bend left=5] (l1);
      %\draw[edge,boxdgray] (x) edge[bend right=10] (l2);
      %\draw[edge,boxdgray] (x) edge[bend left=10] (i1);
      %\draw[edge,boxdgray] (x) edge[bend right=20] (i2);
      ...
      %\draw[edge,boxdgray] (y) edge[bend left=10] (i3);
      %\draw[edge,boxdgray] (y) edge[bend right=20] (i4);
      %\node (out) at ($(r) + (0,0.9)$) {\scriptsize\colorbox{boxgreen}{\color{white}$\mathbf{.185}$}};
      %\draw[edge,boxdgray] (r) edge (out);
    %\end{tikzpicture}
    %}
    %\caption{}
  ...
  %\begin{subfigure}[t]{0.32\textwidth}
    %\begin{tikzpicture}
      ...
      %\node (l1) at ($(x1) + (0,-0.5)$) {\scriptsize\colorbox{boxteal}{\color{white}$\mathbf{0.80}$}};
      %\node (l2) at ($(x2) + (0,-0.5)$) {\scriptsize\colorbox{boxorange}{\color{white}$\mathbf{0.02}$}};
      %\node (l3) at ($(y1) + (0,-0.5)$) {\scriptsize\colorbox{boxpink}{\color{white}$\mathbf{0.56}$}};
      %\node (l4) at ($(y2) + (0,-0.5)$) {\scriptsize\colorbox{boxgoldenrod}{\color{white}$\mathbf{0.99}$}};
      %\draw[edge,boxdgray] (r) edge[bend left=10] (p);
      %\draw[edge,boxdgray] (r) edge[bend left=10] (q);
      %\draw[edge,boxdgray] (p) edge[bend left=10] (x1);
      %\draw[edge,boxdgray] (p) edge[bend left=10] (x2);
      %\draw[edge,boxdgray] (q) edge[bend left=10] (y2);
      %\node at ($(p) + (-0.3,0.6)$) {\scriptsize\colorbox{boxred}{\color{white}$\mathbf{0.25}$}};
      %\node at ($(q) + (0.3,0.6)$) {\scriptsize\colorbox{boxpurple}{\color{white}$\mathbf{0.74}$}};
      %\node (x) at ($(p) + (0,-2.5)$) {\scriptsize\colorbox{boxblue}{\color{white}$\mathstrut\mathbf{x=2}$}};
      %\node (y) at ($(q) + (0,-2.5)$) {\scriptsize\colorbox{boxgreen}{\color{white}$\mathstrut\mathbf{\max y = 3}$}};
      %\draw[edge,boxdgray] (l1) edge (x);
      %\draw[edge,boxdgray] (l2) edge (x);
      %\draw[edge,boxdgray] (l3) edge (y);
      %\draw[edge,boxdgray] (l4) edge (y);
    %\end{tikzpicture}
    %\caption{}
  %\end{subfigure}
  %\caption{}
...
for tractability in all these tasks: the notion of \emph{vtrees} and \emph{structure
...
A PC which is both smooth and decomposable is often referred to as a Sum-Product Network (SPN,
