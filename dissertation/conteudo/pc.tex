...
\begin{example}[sidebyside,lefthand width=0.6\textwidth]{Gaussians as probabilistic circuits}{gaussians} %
  Let $\Leaf_p$ be an input node and $p(X)=\gaussian(X;\mu,\sigma^2)$ a univariate Gaussian
  ...
  \end{center}
\end{example}
Let $\Leaf_p$ be a PC input node and denote $p$ as its inherent probability distribution. By
