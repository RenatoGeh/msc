...
\begin{figure}[t]
  \begin{subfigure}[t]{0.45\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \node at ($(r) + (0,-6.5)$) {\colorbox{boxpink!50}{\color{white}$A=1\quad B=0\quad C=0\quad D=1$}};
      \node (out) at ($(r) + (0,1.5)$) {\colorbox{boxgreen}{\color{white}$\phi(x)=1$}};
  ...
  \caption{Two smooth, structure decomposable and deterministic logic circuits encoding the same
    ...
    right-linear (b) vtree with order $(A,B,C,D)$. In (a), a circuit evaluation for an assignment,
