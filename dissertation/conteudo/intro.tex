...
In \Cref{ch:scalable}, we propose the two scalable structural learning algorithms for probabilistic
circuits that are especially suited for large data and fast deployment.  The final chapter
(\Cref{ch:conclusion}) is dedicated to summarizing our research contributions and pointing to
