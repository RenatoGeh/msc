...
While inference is usually straightforward, as we shall see in \Cref{sec:const}, learning the
...
impose on PCs, as well as what we may gain from them in terms of tractability (\Cref{sec:const}).
