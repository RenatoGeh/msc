...
induced from an LC encoding a certain knowledge base (cf.\ \Cref{section:pckb}); this is usually
done in a case-by-case basis, where LCs are compiled for a particular task and then promoted to
PCs \citep{choi13,oztok15,choi17,shen17}. However, if one does not require specifying the
distribution's support, any PC will do.
