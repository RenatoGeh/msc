...
A $k$-d tree is a subclass of decision trees which essentially hierarchically partition data into
more or less equally sized portions, usually through axis-aligned hyperplanes, that is, they split
the data according to the value of a single variable at a time \citep{bentley75,hang19,ho95}.
