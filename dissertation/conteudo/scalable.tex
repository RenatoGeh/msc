...
iterations can be found in the supplementary material of \Cref{sec:samplepsdd-article}. In the
remaining part of this section, we first address the performance of our proposed approach compared
to the state-of-the-art and then provide an empirical analysis on the impact of vtrees and
parameter choice for ensembles of \textproc{SamplePSDD}
...
\begin{figure}[t]
  \begin{subfigure}{0.495\textwidth}
    \includegraphics[width=\textwidth]{ll_led.pdf}
    \caption{}
    \label{fig:ll-led}
  \end{subfigure}
  \begin{subfigure}{0.495\textwidth}
    \includegraphics[width=\textwidth]{ll_led_pixels.pdf}
    \caption{}
    \label{fig:ll-led-pixels}
  \end{subfigure}
  \caption{Log-likelihoods for the unpixelized \texttt{led} \textbf{(a)} and pixelized
    \texttt{led-pixels} \textbf{(a)} datasets.}
